...
支撑材料压缩包包含以下内容：
\begin{itemize}
\item \path{code/run_fusion.py}（融合流程入口）、\path{code/run_hybrid.py}（线性规划内核）与\path{code/README.md}；
...
\lstinputlisting[language=Python,basicstyle=\ttfamily\tiny]{../code/run_fusion.py}
